...
function header() {
  ...
  const handleItemClick = (item) => {
    setSelectedItem(item === selectedItem ? "" : item); // Toggle selection
  };
        ...
        <div className="flex items-center justify-between py-2">
          ...
          <div className="flex gap-10">
            ...
            <div
              ...
              className={`navigation flex items-center text-white text-md font-bold ${
                selectedItem === "Dashboard" ? "bg-white text-red-500 rounded-lg" : ""
              }`}
            >
              <img src={home} className="w-6 h-6 mr-2" alt="Settings Icon" /> Dashboard
            </div>
            ...
            <a
              ...
              className={`navigation flex items-center text-white text-md font-bold ${
                selectedItem === "Requests" ? "bg-white text-red-500 rounded-lg" : ""
              }`}
            >
              <img src={menu} className="w-6 h-6 mr-2" alt="Settings Icon" /> Requests
            </a>
            <div className="navigation flex items-center text-white text-sm font-bold">
              <img src={feedbacks} className="w-6 h-6 mr-2" alt="Settings Icon" /> Feedbacks
            </div>
            <div className="navigation flex items-center text-white text-sm font-bold">
              <img src={reports} className="w-6 h-6 mr-2" alt="Settings Icon" /> Reports
            </div>
            <div className="navigation flex items-center text-white text-sm font-bold">
              <img src={patient} className="w-6 h-6 mr-2" alt="Settings Icon" /> Patient
            </div>
            <div className="navigation flex items-center text-white text-sm font-bold">
              <img src={settings} className="w-6 h-6 mr-2" alt="Settings Icon" /> Settings
            </div>
          </div>
            ...
            <a href="#" className="text-gray-800">
              <div className="flex justify-center items-center gap-4 mr-10 mt-4">
                <div className="relative md:mb-4 mb-4">
                  <img src={themechange} className="w-10 h-10 justify-between" alt="Bell Icon" />
                </div>
                <div className="relative md:mb-4 mb-4">
                  ...
                  <img src={bellIcon} className="w-6 h-6" alt="Bell Icon" />
                </div>
              </div>
            </a>
          </div>
          ...
          <div className="flex items-center h-20 justify-center mr-3">
            <div className="flex items-center md:gap-2">
              ...
              <p className="text-white mt-3">
                ...
                <span className="block font-bold">Umindu</span>
              </p>
            </div>
          </div>
          {/* end nav-right */}
