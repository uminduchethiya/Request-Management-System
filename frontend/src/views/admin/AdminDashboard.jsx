        ...
        try {
            if (isEditing && selectedRequestId) {
                ...
                const updatedRequests = requests.map(request =>
                    request.id === selectedRequestId ? { ...formData, id: selectedRequestId } : request
                );
            ...
            console.error(isEditing ? 'Error updating request:' : 'Error creating request:', error);
        }
    };
                ...
                <html lang="en">
                    ...
                    <body>
                        <div className="flex justify-between items-center mt-4 mb-2">
                            ...
                            <button
                                className="btn-add bg-blue-500 text-white py-2 px-4 rounded"
                                onClick={() => {
                                    toggleModal();
                                }}
                            >
